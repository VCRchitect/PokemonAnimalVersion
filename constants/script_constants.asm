...
; StoreSwarmMapIndices arguments
	const_def
	const SWARM_TSUCHINOKO ; 0
	const SWARM_DRAGONFLY     ; 1

; ActivateFishingSwarm setval arguments
	const_def
	const FISHSWARM_NONE     ; 0
	const FISHSWARM_BLOWFISH ; 1
	const FISHSWARM_REMORA ; 2
...
; CheckCarpLength return values
	const_def
	const CARPLENGTH_NOT_CARP ; 0
	const CARPLENGTH_REFUSED      ; 1
	const CARPLENGTH_TOO_SHORT    ; 2
	const CARPLENGTH_BEAT_RECORD  ; 3
...
; LettahPuzzle setval arguments
; LoadLettahPuzzlePiecesGFX.LZPointers indexes (see engine/games/lettah_puzzle.asm)
	const_def
	const LETTAHPUZZLE_SHOE_CRAB     ; 0
	const LETTAHPUZZLE_NAUTILUS    ; 1
	const LETTAHPUZZLE_PTERANODON ; 2
	const LETTAHPUZZLE_PHOENIX      ; 3
NUM_LETTAH_PUZZLES EQU const_value

; DisplayLettahWords setval arguments
; LettahWalls and MenuHeaders_LettahWalls indexes (see data/events/lettah_walls.asm)
	const_def
	const LETTAHWORDS_ESCAPE ; 0
	const LETTAHWORDS_LIGHT  ; 1
	const LETTAHWORDS_WATER  ; 2
	const LETTAHWORDS_PHOENIX  ; 3
