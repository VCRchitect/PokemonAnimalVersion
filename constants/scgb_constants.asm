...
; SGBLayoutJumptable indexes (see engine/gfx/sgb_layouts.asm)
	...
	const SCGB_BETA_CLICKER_MINIGAME
	...
	const SCGB_POKEDEX_LETTAH_MODE
	const SCGB_BILLS_PC
	const SCGB_LETTAH_PUZZLE
...
; GetPredefPal arguments (see engine/gfx/color.asm)
	...
	const PREDEFPAL_DIPLOMA ; RB_BRAINMON
	...
	const PREDEFPAL_BETA_SHINY_BRAINMON
	...
	const PREDEFPAL_GS_INTRO_CLAM_PLESIOSAUR
	const PREDEFPAL_BETA_INTRO_PLESIOSAUR
	const PREDEFPAL_GS_INTRO_BLOONBUNCH_CLICKER_BG
	const PREDEFPAL_GS_INTRO_BLOONBUNCH_CLICKER_OB
	const PREDEFPAL_GS_INTRO_STARTERS_TRANSITION
	const PREDEFPAL_BETA_INTRO_VENUSAUR
	const PREDEFPAL_PACK ; GS_INTRO_DRAGON
