...
; Johto story events
	...
	const EVENT_MADE_LARA_CRY
	const EVENT_HERDED_DUCK
	const EVENT_FOUGHT_FAKE_BUSH
	const EVENT_CLEARED_BEAVER_WELL
	const EVENT_REFUSED_TO_TAKE_EGG_FROM_ELMS_AIDE
	const EVENT_GOT_HOBO_CLOWN_EGG_FROM_ELMS_AIDE
	const EVENT_MADE_LETTAH_APPEAR_IN_RUINS
	...
	const EVENT_DIANA_EXPLAINED_AMPHYS_SICKNESS
	const EVENT_LAKE_OF_RAGE_EXPLAINED_WEIRD_CARP
	const EVENT_LAKE_OF_RAGE_ASKED_FOR_CARP
	...
	const EVENT_GOT_JOHN_CENA_FROM_KIYO
...
; Kanto hidden items
	const EVENT_MOLES_CAVE_HIDDEN_MAX_REVIVE
...
; Ruins of Alph puzzles
	const EVENT_SOLVED_PHOENIX_PUZZLE
	const EVENT_SOLVED_SHOE_CRAB_PUZZLE
	const EVENT_SOLVED_NAUTILUS_PUZZLE
	const EVENT_SOLVED_PTERANODON_PUZZLE
; Decorations
	...
	const EVENT_DECO_CLICKER_DOLL
	const EVENT_DECO_SURFING_CLICKER_DOLL
	const EVENT_DECO_CLEFAIRY_DOLL
	const EVENT_DECO_BLOONBUNCH_DOLL
	const EVENT_DECO_BULBASAUR_DOLL
	const EVENT_DECO_SALAMANDER_DOLL
	const EVENT_DECO_SEA_TURTLE_DOLL
	const EVENT_DECO_TADPOLE_DOLL
	const EVENT_DECO_MOLE_DOLL
	const EVENT_DECO_SEASTAR_DOLL
	const EVENT_DECO_CARP_DOLL
	const EVENT_DECO_RADISH_DOLL
	const EVENT_DECO_PHANTOM_DOLL
	const EVENT_DECO_CLAM_DOLL
	const EVENT_DECO_GRIME_DOLL
	const EVENT_DECO_EXPLOSIVE_DOLL
	const EVENT_DECO_LARVA_DOLL
	const EVENT_DECO_LETTAH_DOLL
	const EVENT_DECO_ROCK_DOLL
	const EVENT_DECO_SCRAWNY_DOLL
	const EVENT_DECO_JELLYFISH_DOLL
	const EVENT_PLAYERS_ROOM_POSTER
	const EVENT_DECO_GOLD_TROPHY
	const EVENT_DECO_SILVER_TROPHY
	const EVENT_DECO_BIG_PANDA_DOLL
	const EVENT_DECO_BIG_WYRM_DOLL
	const EVENT_DECO_BIG_PLESIOSAUR_DOLL
; More Johto story events
	...
	const EVENT_LEARNED_BEAVERTAIL
	const EVENT_LEARNED_MOLERAT_TAIL
	...
	const EVENT_FOUGHT_PHOENIX
	const EVENT_FOUGHT_RYUJIN
	const EVENT_BEAT_RIVAL_IN_MT_MOON
	const EVENT_MET_BILLS_GRANDPA
	const EVENT_SHOWED_PERVERT_TO_BILLS_GRANDPA
	const EVENT_SHOWED_RADISH_TO_BILLS_GRANDPA
	const EVENT_SHOWED_STARFISH_TO_BILLS_GRANDPA
	const EVENT_SHOWED_KAI_KEN_FOX_TO_BILLS_GRANDPA
	const EVENT_SHOWED_GERBIL_TO_BILLS_GRANDPA
...
; More Crystal-exclusive events in Johto
	const EVENT_WALL_OPENED_IN_PHOENIX_CHAMBER
	const EVENT_WALL_OPENED_IN_SHOE_CRAB_CHAMBER
	const EVENT_WALL_OPENED_IN_NAUTILUS_CHAMBER
	const EVENT_WALL_OPENED_IN_PTERANODON_CHAMBER
...
; Blackbelt
	...
	const EVENT_BEAT_BLACKBELT_SHINJI
...
; Johto Gym Leaders
	const EVENT_BEAT_BIG_BIRD
	const EVENT_BEAT_TPAIN
	const EVENT_BEAT_LARA
	const EVENT_BEAT_JASON
	const EVENT_BEAT_DIANA
	const EVENT_BEAT_JOSE
	const EVENT_BEAT_LINCOLN
	const EVENT_BEAT_PEELY
; Kanto Gym Leaders
	const EVENT_BEAT_KID_ROCK
	const EVENT_BEAT_MISTY
	const EVENT_BEAT_ARNOLD
...
; Crystal-exclusive trainer flags
	...
	const EVENT_PINECONE_IN_ELMS_LAB
...
; Johto itemballs
	...
	const EVENT_SQUIRREL_POKEBALL_IN_ELMS_LAB
	...
	const EVENT_BEAVER_WELL_B1F_SUPER_POTION
	const EVENT_BEAVER_WELL_B2F_TM_RAIN_DANCE
...
; Johto people
	...
	const EVENT_OLIVINE_LIGHTHOUSE_DIANA
	const EVENT_OLIVINE_GYM_DIANA
	const EVENT_LAKE_OF_RAGE_LANCE
	const EVENT_MAHOGANY_MART_LANCE_AND_MASCOT
	const EVENT_TEAM_ROCKET_BASE_B2F_LANCE
	const EVENT_TEAM_ROCKET_BASE_B3F_LANCE_PASSWORDS
	const EVENT_DRAGONS_DEN_PEELY
	...
	const EVENT_TEAM_ROCKET_BASE_B2F_MASCOT
	const EVENT_TEAM_ROCKET_BASE_B2F_BOMB_1
	const EVENT_TEAM_ROCKET_BASE_B2F_BOMB_2
	const EVENT_TEAM_ROCKET_BASE_B2F_BOMB_3
	...
	const EVENT_CHARCOAL_KILN_DUCK
	const EVENT_CHARCOAL_KILN_APPRENTICE
	const EVENT_CHARCOAL_KILN_BOSS
	const EVENT_ROUTE_36_FAKE_BUSH
	const EVENT_AZALEA_TOWN_BEAVERS
	const EVENT_AZALEA_TOWN_BEAVERTAIL_ROCKET
	const EVENT_BEAVER_WELL_BEAVERS
	const EVENT_BEAVER_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_BEAVER
	...
	const EVENT_TIN_TOWER_ROOF_PHOENIX
	const EVENT_WHIRL_ISLAND_RYUJIN_CHAMBER_RYUJIN
	const EVENT_KURTS_HOUSE_KURT_1
	const EVENT_KURTS_HOUSE_KURT_2
	const EVENT_BEAVER_WELL_KURT
	...
	const EVENT_RUINS_OF_ALPH_SHOE_CRAB_CHAMBER_RECEPTIONIST
	const EVENT_OPENED_MT_SILVER
	const EVENT_FOUGHT_PANDA
	const EVENT_LAKE_OF_RAGE_RED_INKANYAMBA
	...
	const EVENT_FLORIA_AT_FAKE_BUSH
...
; Kanto people
	...
	const EVENT_VERMILION_CITY_PANDA
...
; New to Crystal
	...
	const EVENT_DRAGON_SHRINE_PEELY
	...
	const EVENT_PICKED_UP_GOLD_BERRY_FROM_PHOENIX_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTERYBERRY_FROM_PHOENIX_ITEM_ROOM
	const EVENT_PICKED_UP_REVIVAL_HERB_FROM_PHOENIX_ITEM_ROOM
	const EVENT_PICKED_UP_CHARCOAL_FROM_PHOENIX_ITEM_ROOM
	const EVENT_PICKED_UP_BERRY_FROM_SHOE_CRAB_ITEM_ROOM
	const EVENT_PICKED_UP_PSNCUREBERRY_FROM_SHOE_CRAB_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_SHOE_CRAB_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGYPOWDER_FROM_SHOE_CRAB_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTERYBERRY_FROM_NAUTILUS_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTIC_WATER_FROM_NAUTILUS_ITEM_ROOM
	const EVENT_PICKED_UP_STARDUST_FROM_NAUTILUS_ITEM_ROOM
	const EVENT_PICKED_UP_STAR_PIECE_FROM_NAUTILUS_ITEM_ROOM
	const EVENT_PICKED_UP_GOLD_BERRY_FROM_PTERANODON_ITEM_ROOM
	const EVENT_PICKED_UP_MOON_STONE_FROM_PTERANODON_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_PTERANODON_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGY_ROOT_FROM_PTERANODON_ITEM_ROOM
	...
	const EVENT_SAW_FENRIR_AT_CIANWOOD_CITY
	const EVENT_SAW_FENRIR_ON_ROUTE_42
	const EVENT_SAW_FENRIR_ON_ROUTE_36
	const EVENT_ECRUTEAK_TIN_TOWER_ENTRANCE_WANDERING_SAGE
	const EVENT_TIN_TOWER_1F_FENRIR
	const EVENT_TIN_TOWER_1F_CERBERUS
	const EVENT_TIN_TOWER_1F_BARGHEST
	const EVENT_TIN_TOWER_1F_EUSINE
	const EVENT_TIN_TOWER_1F_WISE_TRIO_1
	const EVENT_SET_WHEN_FOUGHT_PHOENIX
