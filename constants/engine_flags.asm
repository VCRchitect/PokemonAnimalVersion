...
; wUnlockedLettahs
	const ENGINE_UNLOCKED_LETTAHS_A_TO_K
	const ENGINE_UNLOCKED_LETTAHS_L_TO_R
	const ENGINE_UNLOCKED_LETTAHS_S_TO_W
	const ENGINE_UNLOCKED_LETTAHS_X_TO_Z
	const ENGINE_UNLOCKED_LETTAHS_UNUSED_4
	const ENGINE_UNLOCKED_LETTAHS_UNUSED_5
	const ENGINE_UNLOCKED_LETTAHS_UNUSED_6
	const ENGINE_UNLOCKED_LETTAHS_UNUSED_7
; wVisitedSpawns
...
; wDailyFlags2
	...
	const ENGINE_UNION_CAVE_PLESIOSAUR
...
; wSwarmFlags
	const ENGINE_TSUCHINOKO_SWARM
	const ENGINE_DRAGONFLY_SWARM
