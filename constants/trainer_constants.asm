...
NUM_NONTRAINER_PHONECONTACTS EQU const_value - 1
	...
	const RIVAL1_2_SQUIRREL
	const RIVAL1_2_CYNDAQUIL
	const RIVAL1_2_TOTODILE
	const RIVAL1_3_SQUIRREL
	const RIVAL1_3_CYNDAQUIL
	const RIVAL1_3_TOTODILE
	const RIVAL1_4_SQUIRREL
	const RIVAL1_4_CYNDAQUIL
	const RIVAL1_4_TOTODILE
	const RIVAL1_5_SQUIRREL
	...
	const RIVAL2_1_SQUIRREL
	const RIVAL2_1_CYNDAQUIL
	const RIVAL2_1_TOTODILE
	const RIVAL2_2_SQUIRREL
...
KRIS EQU __trainer_class__
	...
	trainerclass NURSELADY ; 47
	const NURSELADY1

	trainerclass BILL_T ; 48
	const BILL1

	trainerclass KURT ; 49
	const KURT1
