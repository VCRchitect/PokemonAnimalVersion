...
; wRoute32SceneID
	const_def 1
	const SCENE_ROUTE32_OFFER_BEAVERTAIL ; 1
...
; wRoute42SceneID
	...
	const SCENE_ROUTE42_FENRIR ; 1

; wCianwoodCitySceneID
	const_def
	const SCENE_CIANWOODCITY_NOTHING            ; 0
	const SCENE_CIANWOODCITY_FENRIR_AND_EUSINE ; 1
...
; wRuinsOfAlphOutsideSceneID
	...
	const SCENE_RUINSOFALPHOUTSIDE_GET_LETTAH_DEX ; 1

; wRuinsOfAlphResearchCenterSceneID
	const_def
	const SCENE_RUINSOFALPHRESEARCHCENTER_NOTHING       ; 0
	const SCENE_RUINSOFALPHRESEARCHCENTER_GET_LETTAH_DEX ; 1
...
; wTeamRocketBaseB2FSceneID
	...
	const SCENE_TEAMROCKETBASEB2F_BOMBS  ; 2
