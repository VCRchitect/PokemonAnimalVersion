; SFX indexes (see audio/sfx_pointers.asm)
	...
	const SFX_GS_INTRO_DRAGON_FIREBALL ; a7
...
; new to Crystal
	...
	const SFX_INTRO_LETTAH_1               ; be
	const SFX_INTRO_LETTAH_2               ; bf
	const SFX_INTRO_LETTAH_3               ; c0
	const SFX_SLIME_POP_UP                ; c1
	const SFX_SLIME_TRANSFORM             ; c2
	const SFX_INTRO_FENRIR_1             ; c3
	const SFX_INTRO_GERBIL                 ; c4
	const SFX_INTRO_FENRIR_2             ; c5
	const SFX_INTRO_FENRIR_3             ; c6
	const SFX_SLIME_BOUNCE                ; c7
	const SFX_INTRO_FENRIR_4             ; c8
