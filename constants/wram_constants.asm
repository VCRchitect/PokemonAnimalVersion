...
; wStatusFlags::
	...
	const STATUSFLAGS_LETTAH_DEX_F                ; 1
...
; wDailyFlags2::
	...
	const DAILYFLAGS2_UNION_CAVE_PLESIOSAUR_F                 ; 1
...
; wSwarmFlags::
	...
	const SWARMFLAGS_TSUCHINOKO_SWARM_F           ; 2
	const SWARMFLAGS_DRAGONFLY_SWARM_F               ; 3
