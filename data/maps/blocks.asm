...
MahoganyRedInkanyambaSpeechHouse_Blocks:
...
VermilionMolesCaveSpeechHouse_Blocks:
BluesHouse_Blocks:
...
CianwoodRyujinSpeechHouse_Blocks:
...
EcruteakRyujinSpeechHouse_Blocks:
...
RuinsOfAlphPhoenixChamber_Blocks:
RuinsOfAlphShoe_CrabChamber_Blocks:
RuinsOfAlphNautilusChamber_Blocks:
RuinsOfAlphPteranodonChamber_Blocks:
...
WhirlIslandRyujinChamber_Blocks:
	INCBIN "maps/WhirlIslandRyujinChamber.blk"
...
BetaBeaverWell1F_Blocks: ; unreferenced
	INCBIN "maps/unused/BetaBeaverWell1F.blk"

BeaverWellB1F_Blocks:
	INCBIN "maps/BeaverWellB1F.blk"

BeaverWellB2F_Blocks:
	INCBIN "maps/BeaverWellB2F.blk"
...
RuinsOfAlphPhoenixItemRoom_Blocks:
RuinsOfAlphShoe_CrabItemRoom_Blocks:
RuinsOfAlphNautilusItemRoom_Blocks:
RuinsOfAlphPteranodonItemRoom_Blocks:
	INCBIN "maps/RuinsOfAlphItemRoom.blk"

RuinsOfAlphPhoenixWordRoom_Blocks:
	INCBIN "maps/RuinsOfAlphPhoenixWordRoom.blk"

RuinsOfAlphShoe_CrabWordRoom_Blocks:
	INCBIN "maps/RuinsOfAlphShoe_CrabWordRoom.blk"

RuinsOfAlphNautilusWordRoom_Blocks:
	INCBIN "maps/RuinsOfAlphNautilusWordRoom.blk"

RuinsOfAlphPteranodonWordRoom_Blocks:
	INCBIN "maps/RuinsOfAlphPteranodonWordRoom.blk"
