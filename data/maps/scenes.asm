...
MapScenes::
	...
	scene_var RUINS_OF_ALPH_PHOENIX_CHAMBER,                 wRuinsOfAlphPhoenixChamberSceneID
	scene_var RUINS_OF_ALPH_SHOE_CRAB_CHAMBER,                wRuinsOfAlphShoe_CrabChamberSceneID
	scene_var RUINS_OF_ALPH_NAUTILUS_CHAMBER,               wRuinsOfAlphNautilusChamberSceneID
	scene_var RUINS_OF_ALPH_PTERANODON_CHAMBER,            wRuinsOfAlphPteranodonChamberSceneID
