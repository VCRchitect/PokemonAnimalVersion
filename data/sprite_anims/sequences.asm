...
; SPRITE_ANIM_INDEX_SLOTS_RUBBLE
	db SPRITE_ANIM_FRAMESET_SLOTS_RUBBLE,               SPRITE_ANIM_SEQ_SLOTS_RUBBLE,               SPRITE_ANIM_DICT_SLOTS
...
; SPRITE_ANIM_INDEX_GS_INTRO_PHOENIX_RYUJIN
	db SPRITE_ANIM_FRAMESET_GS_INTRO_PHOENIX_RYUJIN,      SPRITE_ANIM_SEQ_GS_INTRO_PHOENIX_RYUJIN,      SPRITE_ANIM_DICT_DEFAULT
...
; SPRITE_ANIM_INDEX_INTRO_FENRIR
	db SPRITE_ANIM_FRAMESET_INTRO_FENRIR,             SPRITE_ANIM_SEQ_INTRO_FENRIR,             SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_INTRO_GERBIL
	db SPRITE_ANIM_FRAMESET_INTRO_GERBIL,               SPRITE_ANIM_SEQ_INTRO_GERBIL_SHAGS2DOPE,        SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_INTRO_SHAGS2DOPE
	db SPRITE_ANIM_FRAMESET_INTRO_SHAGS2DOPE,              SPRITE_ANIM_SEQ_INTRO_GERBIL_SHAGS2DOPE,        SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_INTRO_LETTAH
	db SPRITE_ANIM_FRAMESET_INTRO_LETTAH_1,             SPRITE_ANIM_SEQ_INTRO_LETTAH,               SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_INTRO_LETTAH_F
	db SPRITE_ANIM_FRAMESET_INTRO_LETTAH_F,             SPRITE_ANIM_SEQ_INTRO_LETTAH_F,             SPRITE_ANIM_DICT_DEFAULT
; SPRITE_ANIM_INDEX_INTRO_FENRIR_AWAY
	db SPRITE_ANIM_FRAMESET_INTRO_FENRIR_AWAY,        SPRITE_ANIM_SEQ_INTRO_FENRIR_AWAY,        SPRITE_ANIM_DICT_DEFAULT
