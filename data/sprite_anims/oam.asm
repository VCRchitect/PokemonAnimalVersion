...
; entries correspond to SPRITE_ANIM_OAMSET_* constants (see constants/sprite_anim_constants.asm)
	...
	dbw $6c, .OAMData_GSIntroClam          ; SPRITE_ANIM_OAMSET_GS_INTRO_CLAM_1
	dbw $6e, .OAMData_GSIntroClam          ; SPRITE_ANIM_OAMSET_GS_INTRO_CLAM_2
	dbw $2d, .OAMData_GSIntroCarp          ; SPRITE_ANIM_OAMSET_GS_INTRO_CARP_1
	dbw $4d, .OAMData_GSIntroCarp          ; SPRITE_ANIM_OAMSET_GS_INTRO_CARP_2
	dbw $60, .OAMData_GSIntroPlesiosaur            ; SPRITE_ANIM_OAMSET_GS_INTRO_UNUSED_PLESIOSAUR
	dbw $00, .OAMData_GSIntroPlesiosaur            ; SPRITE_ANIM_OAMSET_GS_INTRO_PLESIOSAUR_1
	dbw $00, .OAMData_GSIntroPlesiosaur            ; SPRITE_ANIM_OAMSET_GS_INTRO_PLESIOSAUR_2
	dbw $06, .OAMData_GSIntroPlesiosaur            ; SPRITE_ANIM_OAMSET_GS_INTRO_PLESIOSAUR_3
	...
	dbw $00, .OAMData_GSIntroBloonbunchClicker ; SPRITE_ANIM_OAMSET_GS_INTRO_BLOONBUNCH_1
	dbw $04, .OAMData_GSIntroBloonbunchClicker ; SPRITE_ANIM_OAMSET_GS_INTRO_BLOONBUNCH_2
	dbw $08, .OAMData_GSIntroBloonbunchClicker ; SPRITE_ANIM_OAMSET_GS_INTRO_BLOONBUNCH_3
	dbw $40, .OAMData_GSIntroBloonbunchClicker ; SPRITE_ANIM_OAMSET_GS_INTRO_CLICKER_1
	dbw $44, .OAMData_GSIntroBloonbunchClicker ; SPRITE_ANIM_OAMSET_GS_INTRO_CLICKER_2
	dbw $48, .OAMData_GSIntroBloonbunchClicker ; SPRITE_ANIM_OAMSET_GS_INTRO_CLICKER_3
	dbw $4c, .OAMData_GSIntroBloonbunchClicker ; SPRITE_ANIM_OAMSET_GS_INTRO_CLICKER_4
	dbw $80, .OAMData_GSIntroClickerTail       ; SPRITE_ANIM_OAMSET_GS_INTRO_CLICKER_TAIL_1
	dbw $85, .OAMData_GSIntroClickerTail       ; SPRITE_ANIM_OAMSET_GS_INTRO_CLICKER_TAIL_2
	dbw $8a, .OAMData_GSIntroClickerTail       ; SPRITE_ANIM_OAMSET_GS_INTRO_CLICKER_TAIL_3
	dbw $00, .OAMData_IntroLettahF2_1           ; SPRITE_ANIM_OAMSET_GS_INTRO_SMALL_FIREBALL
	...
	dbw $10, .OAMData_GSIntroStarter           ; SPRITE_ANIM_OAMSET_GS_INTRO_SQUIRREL
	...
	dbw $00, .OAMData_SlotsRubble               ; SPRITE_ANIM_OAMSET_SLOTS_RUBBLE_1
	dbw $08, .OAMData_SlotsRubble               ; SPRITE_ANIM_OAMSET_SLOTS_RUBBLE_2
	...
	dbw $00, .OAMData_GSIntroPhoenixRyujin1        ; SPRITE_ANIM_OAMSET_GS_INTRO_PHOENIX_RYUJIN_1
	dbw $00, .OAMData_GSIntroPhoenixRyujin2        ; SPRITE_ANIM_OAMSET_GS_INTRO_PHOENIX_RYUJIN_2
	dbw $00, .OAMData_GSIntroPhoenixRyujin3        ; SPRITE_ANIM_OAMSET_GS_INTRO_PHOENIX_RYUJIN_3
	dbw $00, .OAMData_GSIntroPhoenixRyujin4        ; SPRITE_ANIM_OAMSET_GS_INTRO_PHOENIX_RYUJIN_4
	dbw $00, .OAMData_GSIntroPhoenixRyujin5        ; SPRITE_ANIM_OAMSET_GS_INTRO_PHOENIX_RYUJIN_5
	...
	dbw $00, .OAMData_IntroFenrir1            ; SPRITE_ANIM_OAMSET_INTRO_FENRIR_1
	dbw $08, .OAMData_IntroFenrir2            ; SPRITE_ANIM_OAMSET_INTRO_FENRIR_2
	dbw $60, .OAMData_IntroFenrir3            ; SPRITE_ANIM_OAMSET_INTRO_FENRIR_3
	dbw $68, .OAMData_IntroFenrir4            ; SPRITE_ANIM_OAMSET_INTRO_FENRIR_4
	...
	dbw $00, .OAMData_IntroLettahF2_1           ; SPRITE_ANIM_OAMSET_INTRO_LETTAH_F_2_1
	dbw $01, .OAMData_IntroLettahF2_2           ; SPRITE_ANIM_OAMSET_INTRO_LETTAH_F_2_2
	dbw $03, .OAMData_IntroLettahF2_3           ; SPRITE_ANIM_OAMSET_INTRO_LETTAH_F_2_3
	dbw $08, .OAMData_IntroLettahF2_4_5         ; SPRITE_ANIM_OAMSET_INTRO_LETTAH_F_2_4
	dbw $1c, .OAMData_IntroLettahF2_4_5         ; SPRITE_ANIM_OAMSET_INTRO_LETTAH_F_2_5
	dbw $80, .OAMData_IntroFenrirAway         ; SPRITE_ANIM_OAMSET_INTRO_FENRIR_AWAY
...
.OAMData_GSIntroBloonbunchClicker:
	db 16
	dbsprite -2, -2,  0,  0, $00, 0
	dbsprite -1, -2,  0,  0, $01, 0
