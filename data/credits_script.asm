...
; Update the banner.
	db CREDITS_SCENE, 1 ; Bowlcut

	db      GRAPHICS_DESIGN, 0
	db     HIRONOBU_SKUNKDA, 1
	db          JUN_OKUTANI, 2
	db       ASUKA_IWASHITA, 3
