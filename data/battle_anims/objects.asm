...
; ANIM_OBJ_SLUDGE
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_1F, BATTLEANIMFUNC_GRIME, PAL_BATTLE_OB_GRAY, ANIM_GFX_POISON
...
; ANIM_OBJ_BUBBLE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_21, BATTLEANIMFUNC_BUBBLE, PAL_BATTLE_OB_GRAY, ANIM_GFX_BUBBLE
; ANIM_OBJ_SURF
...
; ANIM_OBJ_CIGARETTE
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $90, BATTLEANIMFRAMESET_71, BATTLEANIMFUNC_HORN, PAL_BATTLE_OB_GRAY, ANIM_GFX_SMOKE
; ANIM_OBJ_PSYCH_UP
