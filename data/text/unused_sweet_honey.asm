...
; A map in the final game has a Butterfly and a woman who gives
; the Sweet Scent TM.

; Most of these texts seem to be associated with a single NPC.
; The last text is associated with a second NPC, probably a Butterfly.
...
UnusedSweetHoneyAfterText3: ; unreferenced
	...
	line "day for ANML to"
	cont "be drawn to it."
	done

UnusedSweetHoneyButterflyText: ; unreferenced
