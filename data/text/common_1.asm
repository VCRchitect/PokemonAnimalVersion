...
_LookBloonbunchPosterText::
	text "It's a poster of a"
	line "cute BLOONBUNCH."
	done
...
_ObtainedTheExplosiveBadgeText:: ; unreferenced
	text "Obtained the"
	line "EXPLOSIVEBADGE!"
	done
...
_FoundAnEggText::
	...
	line "your ANIMLs, and"

	para "my goodness, were"
	line "we surprised!"

	para "Your ANIMALs had"
	line "an EGG!"
