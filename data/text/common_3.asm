...
_ChangeBoxSaveText::
	text "When you change an"
	line "ANIMAL BOX, data"
...
_DeleterIntroText::
	...
	para "I can make ANIMALs"
	line "forget moves."

	para "Shall I make an"
	line "ANIMAL forget?"
	done
