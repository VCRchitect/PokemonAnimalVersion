...
_KarpGuruRecordText::
	...
	text " caught by"
	line "@"
	text_ram wCarpRecordHoldersName
	text_promptbutton
	text_end
...
_OakPCText1::
	...
	line "ANIMALDEX rated?"
	done

_OakPCText2::
	text "Current ANIMALDEX"
...
_OakRating13::
	...
	line "more ANIMALs than"

	para "the last ANIMALDEX"
...
_OakText1::
	text "Howdy! Sorry for"
	line "the wait."

	para "Some people will"
	line "sleep when they"
	cont "are depressed."

	para "I-I'm not sad."
	line "I'm tired, is all."

	para "My name is OAK."

	para "I have a mystery"
	line "on my hands."
	cont "We all do."
	prompt
...
_OakText4::
	...
	line "are perverts in"
	cont "big costumes."

	para "No matter what,"
	line "ANIMALs are full"
	cont "of mysteries!"
	prompt
