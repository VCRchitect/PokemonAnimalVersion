...
.JohtoStarters: db BUENA_MON,    10, SKUNK, CAIMAN, SQUIRREL
...
.Pokemon1:      db BUENA_MON,    10, CLICKER, RAT, ROCK
.Pokemon2:      db BUENA_MON,    10, OWL, SPIDER, TAPIR
...
.RadioStations: db BUENA_STRING, 13, "ANML Talk@", "ANML Music@", "Lucky Channel@"
