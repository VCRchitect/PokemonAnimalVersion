...
.RomHackTeam:          db " ROM HACK DEVELOPMENT"     ; "きかくかいはつぶ@"
						next "   SPECIAL THANKS"
						next "                 @"
.ax6:					db "        ax6@       "
						next "(for the randomtext script)"
						next "                     @"
.JaimeEspino:   			db "     Jaime Espino "
						next "(for urging me to finish)"
                     next "                    @"
.MyWife:				   	db"       Mareford@"
						next "(for putting up with my late nights)"
						next "                      @"
.Pret:					db "         Pret" 
						next "(for being a great resource and help)"
						next "                      @"
.JoseAlvarez:			db "      Jose Alvarez    "
						next "(for listening to me talk)"
						next "                      @"
.WillisMcNeil:			db "       Willis McNeil     "
                     next "(for being so damn supportive)"
						next "                        @"						
...
.RenaSkunkkawa:       db "   RENA SKUNKKAWA@"         ; "よしかわ　れな@"
.JunOkutani:          db "    JUN OKUTANI@"           ; "おくたに　じゅん@"
.HironobuSkunkda:     db "  HIRONOBU SKUNKDA@"        ; "よしだ　ひろのぶ@"
...
.SkunknoriMatsuda:    db " SKUNKNORI MATSUDA@"        ; "まつだ　よしのり@"
...
.KazuskunkOsawa:      db "  KAZUSKUNK OSAWA@"
.KimikoNakamichi:     db "  KIMIKO NAKAMICHI@"
.Staff:               db "      ANML"                 ; "ポケットモンスター"
...
.PokemonAnimation:    db " ANML ANIMATION@"           ; "#　アニメーション@"
.PokedexText:         db "    ANMLDEX TEXT@"             ; "ずかん　テキスト@"
