...
MrPokemonsHouse_OakScript:
	...
	iftrue .RivalTakesSquirrel
	checkevent EVENT_GOT_SQUIRREL_FROM_ELM
	iftrue .RivalTakesSkunk
	setevent EVENT_TOTODILE_POKEBALL_IN_ELMS_LAB
	end

.RivalTakesSquirrel:
	setevent EVENT_SQUIRREL_POKEBALL_IN_ELMS_LAB
	end
...
MrPokemonsHouse_OakText1:
	...
	para "an ANIMAL for this"
	line "errand."

	para "To researchers"
	line "like PROF.ELM and"

	para "I, ANIMALs are our"
	line "friends."
