	...
	const INDIGOPLATEAUPOKECENTER1F_BAG_LADY
...
IndigoPlateauPokecenter1F_MapEvents:
	...
	object_event  0,  9, SPRITE_DRAG_QUEEN, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Bag_LadyScript, EVENT_TELEPORT_GUY
