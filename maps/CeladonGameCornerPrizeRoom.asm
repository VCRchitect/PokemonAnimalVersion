...
CELADONGAMECORNERPRIZEROOM_CLICKER_COINS  EQU 2222
CELADONGAMECORNERPRIZEROOM_LOPOLYFACE_COINS  EQU 5555
CELADONGAMECORNERPRIZEROOM_RAPTOR_COINS EQU 8888
...
.loop
	...
	closewindow
	ifequal 1, .Clicker
	ifequal 2, .Lopolyface
	ifequal 3, .Raptor
	sjump CeladonPrizeRoom_CancelPurchaseScript

.Clicker:
	checkcoins CELADONGAMECORNERPRIZEROOM_CLICKER_COINS
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, CeladonPrizeRoom_notenoughroom
	getmonname STRING_BUFFER_3, CLICKER
	scall CeladonPrizeRoom_askbuy
	iffalse CeladonPrizeRoom_CancelPurchaseScript
	waitsfx
	playsound SFX_TRANSACTION
	...
	givepoke CLICKER, 25
	takecoins CELADONGAMECORNERPRIZEROOM_CLICKER_COINS
	sjump .loop

.Lopolyface:
	checkcoins CELADONGAMECORNERPRIZEROOM_LOPOLYFACE_COINS
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, CeladonPrizeRoom_notenoughroom
	getmonname STRING_BUFFER_3, LOPOLYFACE
	scall CeladonPrizeRoom_askbuy
	iffalse CeladonPrizeRoom_CancelPurchaseScript
	waitsfx
	playsound SFX_TRANSACTION
	...
	setval LOPOLYFACE
	special GameCornerPrizeMonCheckDex
	givepoke LOPOLYFACE, 15
	takecoins CELADONGAMECORNERPRIZEROOM_LOPOLYFACE_COINS
	sjump .loop

.Raptor:
	checkcoins CELADONGAMECORNERPRIZEROOM_RAPTOR_COINS
	ifequal HAVE_LESS, CeladonPrizeRoom_notenoughcoins
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, CeladonPrizeRoom_notenoughroom
	...
	special GameCornerPrizeMonCheckDex
	givepoke RAPTOR, 40
	takecoins CELADONGAMECORNERPRIZEROOM_RAPTOR_COINS
	sjump .loop
...
.MenuData:
	db STATICMENU_CURSOR ; flags
	db 4 ; items
	db "CLICKER    {d:CELADONGAMECORNERPRIZEROOM_CLICKER_COINS}@"
	db "LOPOLYFACE    {d:CELADONGAMECORNERPRIZEROOM_LOPOLYFACE_COINS}@"
	db "RAPTOR   {d:CELADONGAMECORNERPRIZEROOM_RAPTOR_COINS}@"
	db "CANCEL@"

CeladonGameCornerPrizeRoomGentlemanText:
	text "I wanted LOPOLYFACE,"
