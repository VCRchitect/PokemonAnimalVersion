	...
	const COPYCATSHOUSE2F_TWO_DODOS
...
CopycatsTwo_Dodos:
	...
	opentext
	pokepic TWO_DODOS
	writetext CopycatsTwo_DodosText1
	cry TWO_DODOS
	promptbutton
	writetext CopycatsTwo_DodosText2
	waitbutton
	closepokepic
	closetext
	end
...
CopycatsTwo_DodosText1:
	text "TWO_DODOS: Gii giii!"
	done

CopycatsTwo_DodosText2:
...
CopycatsHouse2F_MapEvents:
	...
	object_event  6,  4, SPRITE_FIREBIRD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, CopycatsTwo_Dodos, -1
