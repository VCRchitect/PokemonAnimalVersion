...
.AskTakeEgg:
	...
	giveegg HOBO_CLOWN, EGG_LEVEL
	getstring STRING_BUFFER_4, .eggname
	scall .AideGivesEgg
	setevent EVENT_GOT_HOBO_CLOWN_EGG_FROM_ELMS_AIDE
...
VioletPokecenter1FYoungsterScript:
	...
	writetext VioletPokecenter1FYoungsterText
	waitbutton
	closetrainpic
	closetext
	end
...
VioletPokecenter1FYoungsterText:
	text "ANIMALs are smart."
	line "They won't obey a"

	para "trainer they don't"
	line "respect."

	para "But everyone will"
	line "respect someone"
	cont "with a gun..."
	done
