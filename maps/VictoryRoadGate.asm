...
VictoryRoadGateLeftBlackBeltText:
	...
	line "strong ANIMALs out"
	cont "there."
	done

VictoryRoadGateRightBlackBeltText:
	text "Off to the ANIMAL"
	line "LEAGUE, are you?"
...
VictoryRoadGate_MapEvents:
	...
	object_event 12,  5, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VictoryRoadGateRightBlackBeltScript, EVENT_FOUGHT_PANDA
