...
CeruleanCitySazae_Oni:
	refreshscreen
	opentext
	pokepic SAZAE_ONI
	writetext CeruleanCitySazae_OniText
	cry SAZAE_ONI
	waitbutton
	closepokepic
	closetext
...
CeruleanCitySazae_OniText:
	text "SAZAE_ONI: Yarah?"
	done

CeruleanCityCooltrainerFText1:
	text "My SAZAE_ONI and I"
	line "make an awesome"
	cont "combination!"
	done

CeruleanCityCooltrainerFText2:
	text "SAZAE_ONI, show me"
	line "your CONFUSION!"
	done
...
CeruleanCitySignText:
	...
	para "A City That Your"
	line "Dumb Ass Can't"
	cont "Pronounce Right"
	done
...
CeruleanCity_MapEvents:
	...
	object_event 20, 24, SPRITE_BEAVER, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, CeruleanCitySazae_Oni, -1
