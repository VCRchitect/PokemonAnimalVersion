...
GOLDENRODGAMECORNER_BAG_LADY_COINS      EQU 100
GOLDENRODGAMECORNER_CUBONE_COINS    EQU 800
GOLDENRODGAMECORNER_ROLYPOLY_COINS EQU 1500
...
.Bag_Lady:
	checkcoins GOLDENRODGAMECORNER_BAG_LADY_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	...
	givepoke BAG_LADY, 5
	takecoins GOLDENRODGAMECORNER_BAG_LADY_COINS
	sjump .loop
...
.Rolypoly:
	checkcoins GOLDENRODGAMECORNER_ROLYPOLY_COINS
	ifequal HAVE_LESS, GoldenrodGameCornerPrizeVendor_NotEnoughCoinsScript
	readvar VAR_PARTYCOUNT
	ifequal PARTY_LENGTH, GoldenrodGameCornerPrizeMonVendor_NoRoomForPrizeScript
	...
	takecoins GOLDENRODGAMECORNER_ROLYPOLY_COINS
	sjump .loop
