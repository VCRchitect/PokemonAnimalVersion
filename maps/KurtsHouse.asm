...
Kurt1:
	...
	iftrue .GotLureBall
	checkevent EVENT_CLEARED_BEAVER_WELL
	iftrue .ClearedBeaverWell
	writetext KurtsHouseKurtMakingBallsMustWaitText
	waitbutton
	closetrainpic
	closetext
	special FadeOutMusic
	setevent EVENT_AZALEA_TOWN_BEAVERTAIL_ROCKET
	readvar VAR_FACING
...
KurtsGranddaughter1:
	...
	checkevent EVENT_CLEARED_BEAVER_WELL
	iftrue .BeaverBack
	checkevent EVENT_AZALEA_TOWN_BEAVERTAIL_ROCKET
	iftrue .Lonely
	opentext
	trainerpic PICNICKER
	writetext KurtsGranddaughterBeaverGoneText
	waitbutton
	closetrainpic
	closetext
	end
...
.BeaverBack:
	...
	opentext
	trainerpic PICNICKER
	writetext KurtsGranddaughterBeaverBackText
	waitbutton
	closetrainpic
	closetext
	end
...
KurtsHouseBeaver:
	...
	opentext
	pokepic BEAVER
	writetext KurtsHouseBeaverText
	cry BEAVER
	waitbutton
	closepokepic
	closetext
...
KurtsGranddaughterBeaverGoneText:
	text "The BEAVER are"
	line "gone... Were they"
...
KurtsGranddaughterBeaverBackText:
	text "The BEAVER my"
...
KurtsHouse_MapEvents:
	...
	object_event  6,  3, SPRITE_BEAVER, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, KurtsHouseBeaver, EVENT_KURTS_HOUSE_BEAVER
