...
MahoganyMart1FLanceUncoversStaircaseScript:
	...
	opentext
	trainerpic CHAMPION
	writetext MahoganyMart1FLanceMascotHyperBeamText
	pause 15
	closetrainpic
	closetext
	playsound SFX_TACKLE
	applymovement MAHOGANYMART1F_MASCOT, MahoganyMart1FMascotTackleMovement
	applymovement MAHOGANYMART1F_BLACK_BELT, MahoganyMart1FBlackBeltKnockedBackMovement
	pause 15
	disappear MAHOGANYMART1F_MASCOT
	pause 15
...
MahoganyMart1FMascotTackleMovement:
	fix_facing
	big_step LEFT
	big_step RIGHT
	remove_fixed_facing
...
MahoganyMart1FBlackBeltText_LanceEntered:
	...
	line "ANIMALs are tough."
	done

MahoganyMart1FLanceMascotHyperBeamText:
	text "LANCE: MASCOT,"
	line "HYPER BEAM."
	done
...
MahoganyMart1F_MapEvents:
	...
	object_event  4,  6, SPRITE_LANCE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_MASCOT
	object_event  3,  6, SPRITE_DRAGON, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_MAHOGANY_MART_LANCE_AND_MASCOT
