...
ExplosiveExplodingTrap:
	special FadeOutPalettes
	cry EXPLOSIVE
	special FadeInPalettes
	setlasttalked -1
	loadvar VAR_BATTLETYPE, BATTLETYPE_TRAP
	loadwildmon EXPLOSIVE, 23
	startbattle
	end
...
TeamRocketBaseB1F_MapEvents:
	...
	; Each Pokémon (Explosive, Virus, Rock) knows Selfdestruct.
