...
GoldenrodUndergroundSwitchRoomEntrancesSuperNerdScript:
	...
	writetext GoldenrodUndergroundSwitchRoomEntrances_SuperNerdText
	waitbutton
	closetrainpic
	closetext
	end
...
GoldenrodUndergroundSwitchRoomEntrancesTeacherScript:
	...
	opentext
	trainerpic TEACHER
	writetext GoldenrodUndergroundSwitchRoomEntrances_TeacherText
	waitbutton
	closetrainpic
	closetext
	end
...
.Caiman:
	winlosstext UndergroundSilverWinText, UndergroundSilverLossText
	setlasttalked GOLDENRODUNDERGROUNDSWITCHROOMENTRANCES_SILVER
	loadtrainer RIVAL1, RIVAL1_4_SQUIRREL
	startbattle
	dontrestartmapmusic
	reloadmapafterbattle
	sjump .FinishRivalBattle
...
UndergroundSilverWinText:
	...
	line "toughest ANIMALs."

	para "I didn't ease up"
	line "on the gas, even"
	para "when I drove into"
	line "the side of that"
	cont "K-Mart..."
...
GruntM11SeenText:
	...
	para "I say that just"
	line "because I've been"
	
	para "trapped down here"
	line "for three days."
	done
...
GruntM25SeenText:
	...
	para "Well, I don't"
	line "understand blinds"
	
	para "or curtains, so"
	line "I can't say much."
...
GruntM25AfterBattleText:
	...
	para "I'm fully aware"
	line "that is a terrible"
	cont "hint."
	done
...
GruntM13SeenText:
	...
	para "You're gonna look"
	line "like the first 10"
	para "minutes of a Law"
	line "and Order episode!"
	done
...
GruntM13AfterBattleText:
	...
	line "anyone that I lost"
	para "to a kid that very"
	line "clearly has some"
	cont "problems."
	done
