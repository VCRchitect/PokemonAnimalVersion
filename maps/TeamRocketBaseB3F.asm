	...
	const TEAMROCKETBASEB3F_FIREBIRD
...
LanceGetPasswordScript:
	...
	pause 5
	turnobject TEAMROCKETBASEB3F_FIREBIRD, RIGHT
	pause 20
...
GruntF5Script:
	...
	closetrainpic
	closetext
	setevent EVENT_LEARNED_BEAVERTAIL
	end
...
GruntM28Script:
	...
	closetrainpic
	closetext
	setevent EVENT_LEARNED_MOLERAT_TAIL
	end
...
.Script:
	opentext
	checkevent EVENT_LEARNED_BEAVERTAIL
	iffalse .NeedsPassword
	checkevent EVENT_LEARNED_MOLERAT_TAIL
	iffalse .NeedsPassword
	sjump .OpenSesame
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  7,  2, SPRITE_FIREBIRD, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, RocketBaseCrow, EVENT_TEAM_ROCKET_BASE_POPULATION
	object_event 21,  7, SPRITE_ROCKET_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, BeaverTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
	object_event  5, 14, SPRITE_ROCKET, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, MoleratTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
