...
Text_FollowEarl:
	text "Is that so? Did"
	line "you try using a"
	cont "strong ANIMAL?"
	done

Text_HereTeacherIAm:
	text "Here I will teach"
	line "you how to not be"
	cont "so terrible."
	done
...
VioletCityLassText:
	...
	para "I wonder if I'd be"
	line "pretty to a ghost?"
	done
...
VioletCitySuperNerdText:
	...
	line "to face a slightly"
	cont "stronger LEADER!"
	done
