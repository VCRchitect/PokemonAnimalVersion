...
Route32_MapScripts:
	...
	scene_script .DummyScene1 ; SCENE_ROUTE32_OFFER_BEAVERTAIL
...
Route32WannaBuyABeaverTailScript:
	turnobject ROUTE32_FISHER4, DOWN
	turnobject PLAYER, UP
	sjump _OfferToSellBeaverTail
...
Route32_MapEvents:
	...
	coord_event  7, 71, SCENE_ROUTE32_OFFER_BEAVERTAIL, Route32WannaBuyABeaverTailScript
	...
	object_event  7, 70, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BeaverTailSalesmanScript, EVENT_BEAVER_WELL_ROCKETS
