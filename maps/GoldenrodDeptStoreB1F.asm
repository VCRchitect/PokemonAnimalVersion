	...
	const GOLDENRODDEPTSTOREB1F_SCRAWNY
...
GoldenrodDeptStoreB1FBlackBelt1Script:
	...
	writetext GoldenrodDeptStoreB1FBlackBelt1Text
	waitbutton
	closetrainpic
	closetext
	end
...
GoldenrodDeptStoreB1FBlackBelt2Script:
	...
	opentext
	trainerpic BLACKBELT_T
	writetext GoldenrodDeptStoreB1FBlackBelt2Text
	waitbutton
	closetrainpic
	closetext
	end
...
GoldenrodDeptStoreB1FBlackBelt3Script:
	...
	opentext
	trainerpic BLACKBELT_T
	writetext GoldenrodDeptStoreB1FBlackBelt3Text
	waitbutton
	closetrainpic
	closetext
	end

GoldenrodDeptStoreB1FScrawnyScript:
	refreshscreen
	opentext
	pokepic HUNK
	writetext GoldenrodDeptStoreB1FHunkText
	cry HUNK
	waitbutton
	closepokepic
	closetext
...
GoldenrodDeptStoreB1F_MapEvents:
	...
	object_event  7,  7, SPRITE_SCRAWNY, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FScrawnyScript, -1
