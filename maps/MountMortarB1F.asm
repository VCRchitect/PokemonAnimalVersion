...
MountMortarB1FKiyoScript:
	...
	checkevent EVENT_GOT_JOHN_CENA_FROM_KIYO
	iftrue .GotJohn_Cena
	...
	trainerpic BLACKBELT_T
.BeatKiyo:
	writetext MountMortarB1FJohn_CenaRewardText
	promptbutton
	waitsfx
	...
	waitsfx
	givepoke JOHN_CENA, 10
	setevent EVENT_GOT_JOHN_CENA_FROM_KIYO
.GotJohn_Cena:
	writetext MountMortarB1FKiyoGotJohn_CenaText
	waitbutton
	closetrainpic
	closetext
	end
...
MountMortarB1FJohn_CenaRewardText:
	text "I-I'm crushed..."
...
MountMortarB1FKiyoGotJohn_CenaText:
	text "JOHN CENA is a"
	line "fighting-type."
