...
RuinsOfAlphOutside_MapScripts:
	...
	scene_script .DummyScene1 ; SCENE_RUINSOFALPHOUTSIDE_GET_LETTAH_DEX
...
.YesScientist:
	...
	setscene SCENE_RUINSOFALPHOUTSIDE_GET_LETTAH_DEX
	endcallback
...
RuinsOfAlphOutsideScientistSceneContinue:
	...
	setmapscene RUINS_OF_ALPH_RESEARCH_CENTER, SCENE_RUINSOFALPHRESEARCHCENTER_GET_LETTAH_DEX
	warpcheck
	end
...
RuinsOfAlphOutsideScientistText:
	...
	line "are really ANIMALS"
	cont "there should be"
	cont "many more."

	para "I know! Let me up-"
	line "grade your ANIMAL"
	cont "DEX. Follow me."
	done
...
RuinsOfAlphOutside_MapEvents:
	...
	def_warp_events
	warp_event  2, 17, RUINS_OF_ALPH_PHOENIX_CHAMBER, 1
	warp_event 14,  7, RUINS_OF_ALPH_SHOE_CRAB_CHAMBER, 1
	warp_event  2, 29, RUINS_OF_ALPH_NAUTILUS_CHAMBER, 1
	warp_event 16, 33, RUINS_OF_ALPH_PTERANODON_CHAMBER, 1
	...
	def_coord_events
	coord_event 11, 14, SCENE_RUINSOFALPHOUTSIDE_GET_LETTAH_DEX, RuinsOfAlphOutsideScientistScene1
	coord_event 10, 15, SCENE_RUINSOFALPHOUTSIDE_GET_LETTAH_DEX, RuinsOfAlphOutsideScientistScene2
