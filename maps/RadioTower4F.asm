...
RadioTower4F_MapEvents:
	...
	object_event 12,  7, SPRITE_KAI_KEN, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, RadioTowerCat, -1
