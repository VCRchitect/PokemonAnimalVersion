...
GoldenrodCityRocket1Script:
	...
	opentext
	trainerpic GRUNTM
	writetext GoldenrodCityRocket1Text
	waitbutton
	closetrainpic
	closetext
	end
...
GoldenrodCityRocket2Script:
	...
	opentext
	trainerpic GRUNTM
	writetext GoldenrodCityRocket2Text
	waitbutton
	closetrainpic
	closetext
	end
...
GoldenrodCityRocket3Script:
	...
	opentext
	trainerpic GRUNTM
	writetext GoldenrodCityRocket3Text
	waitbutton
	closetrainpic
	closetext
	end
...
GoldenrodCityRocket4Script:
	...
	opentext
	trainerpic GRUNTM
	writetext GoldenrodCityRocket4Text
	waitbutton
	closetrainpic
	closetext
	end
