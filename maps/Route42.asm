	...
	const ROUTE42_FENRIR

Route42_MapScripts:
	def_scene_scripts
	scene_script .DummyScene0 ; SCENE_ROUTE42_NOTHING
	scene_script .DummyScene1 ; SCENE_ROUTE42_FENRIR
...
Route42FenrirScript:
	...
	applymovement ROUTE42_FENRIR, Route42FenrirMovement
	disappear ROUTE42_FENRIR
	pause 10
	setscene SCENE_ROUTE42_NOTHING
	clearevent EVENT_SAW_FENRIR_ON_ROUTE_36
	setmapscene ROUTE_36, SCENE_ROUTE36_FENRIR
	end
...
FisherTullyAfterBattleText:
	...
	line "the trainer KING"

	para "using the ANIMALs"
	line "I caught."
...
Route42_MapEvents:
	...
	def_coord_events
	coord_event 24, 14, SCENE_ROUTE42_FENRIR, Route42FenrirScript
	...
	object_event 26, 16, SPRITE_FENRIR, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_SAW_FENRIR_ON_ROUTE_42
