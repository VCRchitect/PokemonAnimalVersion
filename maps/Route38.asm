...
BeautyValerieBeatenText:
	...
	line "see your ANIMALs!"
	done

BeautyValerieAfterBattleText:
	text "When I see ANIMALs"
	line "it seems to"
...
Route38TrainerTipsText:
	...
	line "ANIMAL and stops"
	cont "its evolution."
	
	para "Now if only there"
	line "had been someone"
	para "around to press"
	line "the B Button when"
	para "that damn fish"
	line "climbed out of the"
	para "primordial ooze,"
	line "then we wouldn't"
	cont "be in this mess."
	done
