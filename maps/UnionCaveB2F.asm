	...
	const UNIONCAVEB2F_PLESIOSAUR

UnionCaveB2F_MapScripts:
	def_scene_scripts

	def_callbacks
	callback MAPCALLBACK_OBJECTS, .Plesiosaur

.Plesiosaur:
	checkflag ENGINE_UNION_CAVE_PLESIOSAUR
	iftrue .NoAppear
	readvar VAR_WEEKDAY
	ifequal FRIDAY, .Appear
.NoAppear:
	disappear UNIONCAVEB2F_PLESIOSAUR
	endcallback

.Appear:
	appear UNIONCAVEB2F_PLESIOSAUR
	endcallback
...
UnionCavePlesiosaur:
	...
	cry PLESIOSAUR
	closepokepic
	loadwildmon PLESIOSAUR, 20
	startbattle
	disappear UNIONCAVEB2F_PLESIOSAUR
	setflag ENGINE_UNION_CAVE_PLESIOSAUR
...
UnionCaveB2F_MapEvents:
	...
	object_event 11, 31, SPRITE_SURF, SPRITEMOVEDATA_SWIM_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, UnionCavePlesiosaur, EVENT_UNION_CAVE_B2F_PLESIOSAUR
