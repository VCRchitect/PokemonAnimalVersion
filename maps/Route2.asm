...
Route2MolesCaveSign:
	jumptext Route2MolesCaveSignText
...
Route2_MapEvents:
	...
	warp_event 12,  7, MOLES_CAVE, 3

	def_coord_events

	def_bg_events
	bg_event  7, 51, BGEVENT_READ, Route2Sign
	bg_event 11,  9, BGEVENT_READ, Route2MolesCaveSign
