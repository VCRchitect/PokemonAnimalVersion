...
YoungsterJoey_ImportantBattleScript:
	...
	applymovement ROUTE30_MONSTER2, Route30_JoeysRatAttacksMovement
	opentext
	faceplayer
	...
	closetext
	playsound SFX_TACKLE
	applymovement ROUTE30_MONSTER1, Route30_MikeysRatAttacksMovement
...
Route30_JoeysRatAttacksMovement:
	fix_facing
	big_step UP
	big_step DOWN
	step_end

Route30_MikeysRatAttacksMovement:
	fix_facing
	big_step DOWN
	big_step UP
	step_end
...
Route30TrainerTipsText:
	...
	line "people's ANIMALs!"

	para "The game glitches"
	line "and the ANIMAL "
	cont "won't know moves."
	done
