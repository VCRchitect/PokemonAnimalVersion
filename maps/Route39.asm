...
.WantsClicker:
	trainerpic POKEFANM
	writetext PokefanMDerekClickerIsItText
	waitbutton
	closetrainpic
	closetext
	end
...
PsychicNormanSeenText:
	...
	line "your ANIMALs are"
	cont "capable of."
	done

PsychicNormanBeatenText:
	text "Ooh, your ANIMALs"
	line "have potential."
	done
...
Route39_MapEvents:
	...
	object_event  3, 12, SPRITE_BULL, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39Cow, -1
	object_event  6, 11, SPRITE_BULL, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39Cow, -1
	object_event  4, 15, SPRITE_BULL, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39Cow, -1
	object_event  8, 13, SPRITE_BULL, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route39Cow, -1
