...
HikerDanielAfterBattleText:
	...
	line "buying a BEAVER-"
	cont "TAIL."

	para "I feel sorry for"
	line "the poor ANIMAL."
	done

FirebreatherBillSeenText:
	text "BAT's SUPERSONIC"
