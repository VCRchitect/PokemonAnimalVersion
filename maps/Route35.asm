...
.DragonflySwarming:
	writetext BugCatcherArnieDragonflyText
	waitbutton
	closetext
	end
...
BugCatcherArnieDragonflyText:
	text "Wow... Look at all"
	line "those DRAGONFLYs!"
