...
PalPacket_LettahPuzzle:
	sgb_pal_set LETTAH_PUZZLE, LETTAH_PUZZLE, LETTAH_PUZZLE, LETTAH_PUZZLE

PalPacket_AllPal0:
	sgb_pal_set ROUTES, ROUTES, ROUTES, ROUTES

PalPacket_GSIntroClamPlesiosaur:
	sgb_pal_set GS_INTRO_CLAM_PLESIOSAUR, ROUTES, ROUTES, ROUTES

PalPacket_BetaIntroPlesiosaur: ; unreferenced
	sgb_pal_set BETA_INTRO_PLESIOSAUR, ROUTES, ROUTES, ROUTES

PalPacket_GSIntroBloonbunchClicker:
	sgb_pal_set GS_INTRO_BLOONBUNCH_CLICKER_BG, GS_INTRO_BLOONBUNCH_CLICKER_OB, ROUTES, ROUTES
...
PalPacket_BetaClickerMinigame:
	sgb_pal_set GS_INTRO_BLOONBUNCH_CLICKER_OB, ROUTES, ROUTES, ROUTES
