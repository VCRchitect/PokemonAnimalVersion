...
wDexSearchBeaverFrame:: db
wUnlockedLettahMode:: db
wDexCurLettahIndex:: db
wDexLettahCount:: db
...
NEXTU
; lettah puzzle data
wHoldingLettahPuzzlePiece:: db
wLettahPuzzleCursorPosition:: db
wLettahPuzzleHeldPiece:: db
...
wOaksANMLTalkSegmentCounter:: db
	ds 5
...
; Lettah printing
wPrintedLettahTileSource:: ds 1 tiles
wPrintedLettahTileDest:: ds 1 tiles
...
wRuinsOfAlphPhoenixChamberSceneID::                  db
wRuinsOfAlphShoe_CrabChamberSceneID::                db
wRuinsOfAlphNautilusChamberSceneID::               db
wRuinsOfAlphPteranodonChamberSceneID::            db
...
wDragonflyMapGroup:: db
wDragonflyMapNumber:: db
...
wTsuchinokoMapGroup:: db
wTsuchinokoMapNumber:: db
...
wBestCarpLengthFeet:: db
wBestCarpLengthInches:: db
wCarpRecordHoldersName:: ds NAME_LENGTH
