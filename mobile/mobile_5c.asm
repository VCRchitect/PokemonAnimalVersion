...
Function170d02:
	ld a, $1
	ldh [rVBK], a
	ld de, GerbilBorderMobileGFX
	ld hl, vTiles0 tile $c1
	lb bc, BANK(GerbilBorderMobileGFX), 24
	call Get2bpp
	xor a
	ldh [rVBK], a
	ret

GerbilAnimatedMobileGFX:
INCBIN "gfx/mobile/gerbil_animated.2bpp.lz"

ElectroBallMobileGFX:
INCBIN "gfx/mobile/electro_ball.2bpp.lz"

GerbilBorderMobileGFX:
INCBIN "gfx/mobile/gerbil_border.2bpp"
