...
Sfx_ReadText2:
	channel_count 1
	channel 8, Sfx_ReadText_Ch8
	assert Sfx_ReadText_Ch8 == Sfx_ReadText2_Ch8
...
Sfx_GsIntroDragonFireball:
	channel_count 1
	channel 8, Sfx_GsIntroDragonFireball_Ch8

Sfx_GsIntroDragonFireball_Ch8:
