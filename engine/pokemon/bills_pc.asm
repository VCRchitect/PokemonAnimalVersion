...
.a_button_2
	...
	jr c, .no_space
	call MoveANMLWitoutMail_InsertMon
	ld a, $0
	ld [wJumptableIndex], a
	ret
...
.AllOthersFainted:
	ld de, PCString_NoMoreUsableANML
	jr .NotOkay

.ItsYourLastPokemon:
	ld de, PCString_ItsYourLastANML
.NotOkay:
	call BillsPC_PlaceString
	ld de, SFX_WRONG
	call WaitPlaySFX
...
PCString_ItsYourLastANML: db "It's your last <AN><ML>!@"
PCString_TheresNoRoom: db "There's no room!@"
PCString_NoMoreUsableANML: db "No more usable <AN><ML>!@"
PCString_RemoveMail: db "Remove MAIL.@"
PCString_ReleasedANML: db "Released <AN><ML>.@"
PCString_Bye: db "Bye,@"
