...
PartyMenuStrings:
	dw ChooseAMonString
	dw UseOnWhichANMLString
	dw WhichANMLString
	dw TeachWhichANMLString
	dw MoveToWhereString
	dw UseOnWhichANMLString
	dw ChooseAMonString ; Probably used to be ChooseAFemaleANMLString
	dw ChooseAMonString ; Probably used to be ChooseAMaleANMLString
...
TeachWhichANMLString:
	db "Teach which <AN><ML>?@"
