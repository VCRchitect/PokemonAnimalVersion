...
; Slime is automatically compatible with everything.
; If not Slime, load the breeding groups into b/c and d/e.
	ld a, [wBreedMon2Species]
	cp SLIME
	jr z, .Compatible
	ld [wCurSpecies], a
...
.loop
	...
	cp HOBO_CLOWN
	jr nz, .nothobo_clown
	; set the event flag for hatching hobo_clown
	ld de, EVENT_HOBO_CLOWN_HATCHED
	ld b, SET_FLAG
