...
LettahPuzzle:
	call FadeToMenu
	farcall _LettahPuzzle
	ld a, [wSolvedLettahPuzzle]
	ld [wScriptVar], a
	call ExitAllMenus
	ret
...
; swarm dark cave violet entrance
	ld a, d
	ld [wTsuchinokoMapGroup], a
	ld a, e
	ld [wTsuchinokoMapNumber], a
	ret

.dragonfly
	ld a, d
	ld [wDragonflyMapGroup], a
	ld a, e
	ld [wDragonflyMapNumber], a
	ret
