...
CGBLayoutJumptable:
	...
	dw _CGB_PackPals
	dw _CGB_TrainerCard
	dw _CGB_PokedexLettahMode
	dw _CGB_BillsPC
	dw _CGB_LettahPuzzle
...
.Jumptable:
	dw .ClamPlesiosaurScene
	dw .BloonbunchClickerScene
	dw .StartersDragonScene

.ClamPlesiosaurScene:
	ld hl, .ClamPlesiosaurBGPalette
	ld de, wBGPals1
	call LoadHLPaletteIntoDE
	ld hl, .ClamPlesiosaurOBPals
	ld de, wOBPals1
	ld bc, 2 palettes
	ld a, BANK(wOBPals1)
	call FarCopyWRAM
...
.ClamPlesiosaurBGPalette:
INCLUDE "gfx/intro/gs_clam_plesiosaur_bg.pal"

.ClamPlesiosaurOBPals:
INCLUDE "gfx/intro/gs_clam_plesiosaur_ob.pal"

.BloonbunchClickerScene:
	ld de, wBGPals1
	ld a, PREDEFPAL_GS_INTRO_BLOONBUNCH_CLICKER_BG
	call GetPredefPal
	call LoadHLPaletteIntoDE

	ld de, wOBPals1
	ld a, PREDEFPAL_GS_INTRO_BLOONBUNCH_CLICKER_OB
	call GetPredefPal
	call LoadHLPaletteIntoDE
	call WipeAttrmap
	ret
...
_CGB_LettahPuzzle:
	ld hl, PalPacket_LettahPuzzle + 1
	call CopyFourPalettes
	ld de, wOBPals1
	ld a, PREDEFPAL_LETTAH_PUZZLE
	call GetPredefPal
	call LoadHLPaletteIntoDE
	ldh a, [rSVBK]
	push af
...
_CGB_BetaClickerMinigame:
	ld hl, PalPacket_BetaClickerMinigame + 1
	call CopyFourPalettes
	call WipeAttrmap
	call ApplyAttrmap
	call ApplyPals
...
.GamefreakSlimePalette:
INCLUDE "gfx/splash/slime.pal"
