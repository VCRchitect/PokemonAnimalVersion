...
; entries correspond to SPRITE_ANIM_SEQ_* constants (see constants/sprite_anim_constants.asm)
	...
	dw AnimSeq_FlyLeaf
	dw AnimSeq_FlyTo
	dw AnimSeq_GSIntroPhoenixRyujin
...
.continue
	...
	add hl, bc
	ld [hl], a
	ld a, SPRITE_ANIM_FRAMESET_INTRO_FENRIR_2
	call _ReinitSpriteAnimFrame
	ret
...
AnimSeq_IntroLettahF:
	ld a, [wSlotsDelay]
	cp $40
	ret nz
	ld a, SPRITE_ANIM_FRAMESET_INTRO_LETTAH_F_2
	call _ReinitSpriteAnimFrame
	ret

AnimSeq_IntroFenrirAway:
	ld hl, SPRITEANIMSTRUCT_YCOORD
	add hl, bc
	ld a, [hl]
	add 16
