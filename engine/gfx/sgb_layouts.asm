...
.SGB_PokedexLettahMode:
	call .SGB_Pokedex
	ld de, BlkPacket_PokedexLettahMode
	ret
...
.BlkPacketTable_GSIntro:
	dw BlkPacket_AllPal0, PalPacket_GSIntroClamPlesiosaur
	dw BlkPacket_GSIntroBloonbunchClicker, PalPacket_GSIntroBloonbunchClicker
...
.SGB_BetaClickerMinigame:
	ld hl, PalPacket_BetaClickerMinigame
	ld de, BlkPacket_AllPal0
	ret
