...
; More Pokemon Channel stuff
	dw OaksANMLTalk10    ; $3b
	dw OaksANMLTalk11    ; $3c
	dw OaksANMLTalk12    ; $3d
	dw OaksANMLTalk13    ; $3e
	dw OaksANMLTalk14    ; $3f
; Buenas Password
...
OaksANMLTalk1:
	ld a, 5
	ld [wOaksANMLTalkSegmentCounter], a
...
.sample
	call Random
	and %11111
	cp (OaksANMLTalkRoutes.End - OaksANMLTalkRoutes) / 2
	jr nc, .sample
	ld hl, OaksANMLTalkRoutes
	ld c, a
	ld b, 0
	add hl, bc
	add hl, bc
...
.Adverbs:
	table_width 2, OaksANMLTalk8.Adverbs
...
OaksANMLTalk9:
	...
	ld h, [hl]
	ld l, a
	ld a, [wOaksANMLTalkSegmentCounter]
	dec a
	ld [wOaksANMLTalkSegmentCounter], a
	ld a, OAKS_POKEMON_TALK_4
	jr nz, .ok
...
.Adjectives:
	table_width 2, OaksANMLTalk9.Adjectives
	dw .OPT_CuteText
	dw .OPT_WeirdText
	dw .OPT_PleasantText
