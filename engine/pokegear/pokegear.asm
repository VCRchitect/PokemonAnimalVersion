...
; frequency value given here = 4 × ingame_frequency − 2
	dbw 16, .ANMLTalkAndPokedexShow ; 04.5
...
OaksANMLTalkName:     db "OAK's <AN><ML> Talk@"
PokedexShowName:      db "ANMLDEX Show@"
PokemonMusicName:     db "ANML Music@"
LuckyChannelName:     db "Lucky Channel@"
LettahStationName:     db "?????@"
