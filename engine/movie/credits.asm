...
.Frames:
	dw CreditsGerbilGFX
	dw CreditsGerbilGFX     + 16 tiles
	dw CreditsGerbilGFX     + 32 tiles
	dw CreditsGerbilGFX     + 48 tiles

	dw CreditsBowlcutGFX
	dw CreditsBowlcutGFX  + 16 tiles
	dw CreditsBowlcutGFX  + 32 tiles
	dw CreditsBowlcutGFX  + 48 tiles

	dw CreditsSlimeGFX
	dw CreditsSlimeGFX     + 16 tiles
	dw CreditsSlimeGFX     + 32 tiles
	dw CreditsSlimeGFX     + 48 tiles

	dw CreditsBalloonGFX
	dw CreditsBalloonGFX + 16 tiles
	dw CreditsBalloonGFX + 32 tiles
	dw CreditsBalloonGFX + 48 tiles
...
CreditsGerbilGFX:     INCBIN "gfx/credits/gerbil.2bpp"
CreditsBowlcutGFX:  INCBIN "gfx/credits/bowlcut.2bpp"
CreditsSlimeGFX:     INCBIN "gfx/credits/slime.2bpp"
CreditsBalloonGFX: INCBIN "gfx/credits/balloon.2bpp"
