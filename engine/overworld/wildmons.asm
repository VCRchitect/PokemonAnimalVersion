...
_SwarmWildmonCheck:
	...
	push hl
	ld hl, wSwarmFlags
	bit SWARMFLAGS_TSUCHINOKO_SWARM_F, [hl]
	pop hl
	jr z, .CheckDragonfly
	ld a, [wTsuchinokoMapGroup]
	cp d
	jr nz, .CheckDragonfly
	ld a, [wTsuchinokoMapNumber]
	cp e
	jr nz, .CheckDragonfly
...
.CheckDragonfly:
	push hl
	ld hl, wSwarmFlags
	bit SWARMFLAGS_DRAGONFLY_SWARM_F, [hl]
	pop hl
	jr z, _NoSwarmWildmon
	ld a, [wDragonflyMapGroup]
	cp d
	jr nz, _NoSwarmWildmon
	ld a, [wDragonflyMapNumber]
	cp e
	jr nz, _NoSwarmWildmon
	call LookUpWildmonsForMapDE
	jr nc, _NoSwarmWildmon
...
; barghest starting map
	ld a, GROUP_ROUTE_42
	ld [wRoamMon1MapGroup], a
	ld a, MAP_ROUTE_42
	ld [wRoamMon1MapNumber], a

; cerberus starting map
	ld a, GROUP_ROUTE_37
...
; Randomly select a beast.
	...
	jr z, .DontEncounterRoamMon
	dec a ; 1/3 chance that it's Cerberus, 1/3 chance that it's Barghest
