...
; entries correspond to *_command constants (see macros/scripts/events.asm)
	...
	dw Script_random1j		     ; ad
	dw Script_pbtrainerpic			;ae
...
.fallback
    ld a, YOUNGSTER ; This is the default picture, in case there is a wrong trainer class value in a script.
    jr .ok
	
Script_pbtrainerpic:
	ld [wTempTrainerClass], a
	farcall PBTrainerpic
	ret

Script_closetrainpic:
