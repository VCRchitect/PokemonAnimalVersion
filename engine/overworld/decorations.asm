...
DecorationDesc_PosterPointers:
	...
	dbw DECO_CLICKER_POSTER, DecorationDesc_ClickerPoster
	dbw DECO_CLEFAIRY_POSTER, DecorationDesc_ClefairyPoster
	dbw DECO_BLOONBUNCH_POSTER, DecorationDesc_BloonbunchPoster
	db -1
...
DecorationDesc_ClickerPoster:
	jumptext .LookClickerPosterText

.LookClickerPosterText:
	text_far _LookClickerPosterText
	text_end
...
DecorationDesc_BloonbunchPoster:
	jumptext .LookBloonbunchPosterText

.LookBloonbunchPosterText:
	text_far _LookBloonbunchPosterText
	text_end
