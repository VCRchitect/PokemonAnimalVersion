; wSlotMatched values
	...
	const SLOTS_CLICKER  ; $0c
	const SLOTS_SEA_TURTLE ; $10
	const SLOTS_STARFISH   ; $14
...
; ReelActionJumptable constants
	...
	const REEL_ACTION_INIT_RUBBLE
	const REEL_ACTION_WAIT_RUBBLE
	const REEL_ACTION_END_RUBBLE
...
.Jumptable:
	...
	dw ReelAction_InitRubble                   ; 12
	dw ReelAction_WaitRubble                   ; 13
	dw ReelAction_EndRubble                    ; 14
...
; This is achieved by throwing Rubble until the desired result
; is produced. The amount of Rubble thrown can be anywhere from
;  1 to 14 for SEVEN bias, and 4-8 for no bias.
	...
	ld hl, REEL_ACTION
	add hl, bc
	inc [hl] ; REEL_ACTION_WAIT_RUBBLE
	ld hl, REEL_SPIN_RATE
	add hl, bc
	ld [hl], 0
	call Slots_GetNumberOfRubbles
	push bc
	push af
	depixel 12, 13
	ld a, SPRITE_ANIM_INDEX_SLOTS_RUBBLE
...
.one
	ld hl, REEL_ACTION
	add hl, bc
	inc [hl] ; REEL_ACTION_END_RUBBLE
	ld hl, REEL_SPIN_RATE
	add hl, bc
	ld [hl], 8
	ret

ReelAction_EndRubble:
	xor a
	ld [wSlotsDelay], a
	ld hl, REEL_ACTION
	add hl, bc
	dec [hl] ; REEL_ACTION_WAIT_RUBBLE
	ld hl, REEL_SPIN_RATE
	add hl, bc
	ld [hl], 0
	ret
...
; Big_Egg releases and egg and reel #3 is made to advance 17 slots very
...
.Normal:
	...
	db   4 percent,     SLOTS_STARFISH
	db   8 percent,     SLOTS_SEA_TURTLE
	db  16 percent,     SLOTS_CLICKER
...
.Lucky:
	...
	db   1 percent + 1, SLOTS_POKEBALL
	db   3 percent + 1, SLOTS_STARFISH
	db   6 percent + 1, SLOTS_SEA_TURTLE
	db  12 percent,     SLOTS_CLICKER
...
.PayoutTable:
	...
	dw   6 ; SLOTS_CHERRY
	dw   8 ; SLOTS_CLICKER
	dw  10 ; SLOTS_SEA_TURTLE
	dw  15 ; SLOTS_STARFISH
	assert_table_length NUM_SLOT_REELS
...
.PayoutStrings:
	...
	dbw "8@@@", .LinedUpMonOrCherry ; SLOTS_CLICKER
	dbw "10@@", .LinedUpMonOrCherry ; SLOTS_SEA_TURTLE
	dbw "15@@", .LinedUpMonOrCherry ; SLOTS_STARFISH
	assert_table_length NUM_SLOT_REELS
...
Reel1Tilemap:
	...
	db SLOTS_STARFISH   ;  2
	db SLOTS_CLICKER  ;  3
	db SLOTS_SEA_TURTLE ;  4
	db SLOTS_SEVEN    ;  5
	db SLOTS_CHERRY   ;  6
	db SLOTS_STARFISH   ;  7
	db SLOTS_CLICKER  ;  8
	db SLOTS_SEA_TURTLE ;  9
	db SLOTS_POKEBALL ; 10
	db SLOTS_CHERRY   ; 11
	db SLOTS_STARFISH   ; 12
	db SLOTS_CLICKER  ; 13
	db SLOTS_SEA_TURTLE ; 14
	db SLOTS_SEVEN    ;  0
	db SLOTS_CHERRY   ;  1
	db SLOTS_STARFISH   ;  2
...
Reel2Tilemap:
	...
	db SLOTS_CLICKER  ;  1
	db SLOTS_CHERRY   ;  2
	db SLOTS_SEA_TURTLE ;  3
	db SLOTS_STARFISH   ;  4
	db SLOTS_POKEBALL ;  5
	db SLOTS_CLICKER  ;  6
	db SLOTS_CHERRY   ;  7
	db SLOTS_SEA_TURTLE ;  8
	db SLOTS_STARFISH   ;  9
	db SLOTS_POKEBALL ; 10
	db SLOTS_CLICKER  ; 11
	db SLOTS_CHERRY   ; 12
	db SLOTS_SEA_TURTLE ; 13
	db SLOTS_STARFISH   ; 14
	db SLOTS_SEVEN    ;  0
	db SLOTS_CLICKER  ;  1
	db SLOTS_CHERRY   ;  2
...
Reel3Tilemap:
	...
	db SLOTS_CLICKER  ;  5
	db SLOTS_CHERRY   ;  6
	db SLOTS_SEA_TURTLE ;  7
	db SLOTS_STARFISH   ;  8
	db SLOTS_CLICKER  ;  9
	db SLOTS_POKEBALL ; 10
	db SLOTS_CHERRY   ; 11
	db SLOTS_SEA_TURTLE ; 12
	db SLOTS_STARFISH   ; 13
	db SLOTS_CLICKER  ; 14
	db SLOTS_SEVEN    ;  0
	db SLOTS_CLICKER  ;  1
	db SLOTS_CHERRY   ;  2
