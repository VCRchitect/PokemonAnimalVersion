...
ArnieDragonflySwarm: ; start swarm
	checkflag ENGINE_DRAGONFLY_SWARM
	iftrue ArnieDragonflyAlreadySwarming
	setflag ENGINE_DRAGONFLY_SWARM
	getmonname STRING_BUFFER_4, DRAGONFLY
	swarm SWARM_DRAGONFLY, ROUTE_35
	getlandmarkname STRING_BUFFER_5, LANDMARK_ROUTE_35
