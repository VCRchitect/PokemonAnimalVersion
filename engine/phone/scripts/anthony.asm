...
.TriesSwarm:
	...
	ifequal 0, AnthonyTriesTsuchinokoSwarm
...
AnthonyTriesTsuchinokoSwarm:
	checkflag ENGINE_TSUCHINOKO_SWARM
	iftrue .Generic
	setflag ENGINE_TSUCHINOKO_SWARM
	getmonname STRING_BUFFER_4, TSUCHINOKO
	swarm SWARM_TSUCHINOKO, DARK_CAVE_VIOLET_ENTRANCE
