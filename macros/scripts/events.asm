...
ENDM
	...
	const loadclickerdata_command ; $5a
loadclickerdata: MACRO
	db loadclickerdata_command
ENDM
...
ENDM
	...
	const randomtext_command ; $aa
randomtext: MACRO
 	db randomtext_command
	dab \1
ENDM

	const trainerpic_command ; $ab
trainerpic: macro
	db trainerpic_command
	db \1 ; trainer
ENDM

	const closetrainpic_command ; $ac
closetrainpic: MACRO
	db closetrainpic_command
ENDM

	const random1j_command ; $ad
random1j: MACRO
	db random1j_command
	db \1
	dab \2
ENDM
	...
	const pbtrainerpic_command ; $ae
pbtrainerpic: macro
	db pbtrainerpic_command
ENDM
